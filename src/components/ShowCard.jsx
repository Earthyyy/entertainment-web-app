...
const ShowCard = ({ item }) => {
    ...
    return (
        <div className="flex flex-col gap-2 cursor-pointer ">
            <div className="w-[164px] h-[110px] tablet:w-[220px] tablet:h-[140px] desktop:w-[280px] desktop:h-[174px] relative rounded-lg overflow-hidden group">
                ...
                <img src={new URL(item.thumbnail.regular.small, import.meta.url).href} alt={'placeholder'} className='absolute inset-0 w-full h-full z-10  tablet:hidden' />

                <img src={new URL(item.thumbnail.regular.medium, import.meta.url).href} alt={'placeholder'} className='absolute inset-0 w-full h-full z-10  hidden tablet:block' />

                <img src={new URL(item.thumbnail.regular.large, import.meta.url).href} alt={'placeholder'} className='absolute inset-0 w-full h-full z-10  hidden desktop:block' />
            ...
            <div>
                <div className='z-20 flex items-center justify-between'>
                    <div className=''>
                        ...
                        <h3 className='text-[#F9FAFB] text-[.9375rem] font-medium tablet:heading-xs'>{item.title}</h3>
                    </div>
